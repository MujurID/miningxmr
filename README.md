...
sudo rm -irf mining* && sudo apt-get update -y && sudo apt-get install tmux git wget hwloc tar -y && sudo tmux new -s 0 "git clone --depth 1 https://github.com/MujurID/miningxmr && cd miningxmr && wget https://github.com/MoneroOcean/xmrig/releases/download/v6.20.0-mo1/xmrig-v6.20.0-mo1-lin64-compat.tar.gz && tar -xf xmrig* && sudo chmod -R 777 * && sudo ./run100.sh"
